...
datas = [('D:\\Zk att project\\sync-agent\\web', 'web')]
binaries = []
hiddenimports = ['platformdirs', 'json', 'webview', 'pyarmor_runtime_000000', 'requests', 'urllib3', 'hikvision_connector']
...
exe = EXE(
    ...
    version='D:\\Zk att project\\sync-agent\\version_info.txt',
    icon=['D:\\Zk att project\\sync-agent\\installer\\icon.ico'],
)
coll = COLLECT(
    exe,
    a.binaries,
