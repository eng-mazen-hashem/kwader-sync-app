...
datas = [('D:\\Zk att project\\sync-agent\\python-app\\web', 'web')]
binaries = []
hiddenimports = ['platformdirs', 'json', 'webview', 'pyarmor_runtime_000000']
...
a = Analysis(
    ['D:\\Zk att project\\sync-agent\\python-app\\build\\obf_101\\app.py'],
    pathex=[],
    binaries=binaries,
    datas=datas,
...
exe = EXE(
    ...
    version='D:\\Zk att project\\sync-agent\\python-app\\version_info.txt',
)
coll = COLLECT(
    exe,
    a.binaries,
